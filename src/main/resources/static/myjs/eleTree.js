...
layui.define(["jquery","laytpl"], function (exports) {
    ...
    Class.prototype={
        ...
        //重新加载数据(如果传入arrData,那么就渲染arrData的数据,如果没有传入数据就使用ajax请求数据)
        reload: function(arrData) {
        ...
        nodeEvent: function() {
            ...
            options.elem.on("click",".eleTree-node-content",function(e) {
                ...
                //让被点击的节点处于激活状态,去除其他节点 的激活状态
                $(".eleTree-node-content-active").removeClass("eleTree-node-content-active");
                //console.dir(eleNode.context)
                $(eleNode.context).addClass("eleTree-node-content-active");
                ...
                $(document).on("mousemove",function(e) {
                    ...
                    layui.event.call(target, MOD_NAME, 'nodeDrag('+ _self.filter +')', {
                        ...
                        getIndex:function () {
                            ...
                            return _self.reInitData(target).index.length;
                        },
                        move:function(){
                            // 数据更改
